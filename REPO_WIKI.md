...
├── pages/           # Home, Category, Achievements, Game*（16 个游戏页）
...
- **覆盖**：数据与工具、首页与分类、成就页、16 个游戏页冒烟、五子棋胜负、麻将规则（国标/川麻/日麻）。  
...
| 优先级 | 项 | 说明 |
|--------|----|------|
| **P1** | 再上 1 款占位游戏 | 斗地主简化版 或 升级入门，延续一游戏一迭代 |
