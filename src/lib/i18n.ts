...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'game.mahjong-japanese.description': '立直、役种、符与点数计算。',
  ...
  en: {
    ...
    'game.go.name': 'Go (Coming soon)',
    'game.go.description': 'Black vs white; surround territory.',
    'game.xiangqi.name': 'Xiangqi (Coming soon)',
    'game.xiangqi.description': 'Chinese chess.',
    'game.chess.name': 'Chess (Coming soon)',
    ...
    'game.mahjong-japanese.description': 'Riichi, yaku, fu and points.',
